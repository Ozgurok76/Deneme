...
const fs = require("fs"); //RED2GAME
require("./util/eventLoader")(client); //RED2GAME
...
client.on('clickButton', async(button) => {
    ...
    const onaymsj = new Discord.MessageEmbed()
        .setAuthor('Red2Game', button.message.guild.iconURL({ dynamic: true, type: 'gif', size: 1024 }))
